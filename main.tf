...
module "eks" {
  ...
  public_subnet  = module.vpc.pub_subnet # Ensure correct reference
  private_subnet = module.vpc.pvt_subnet # Ensure correct reference
  # private_subnet = flatten(module.vpc.pvt_subnet)
